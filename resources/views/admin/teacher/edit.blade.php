...
@section('content')
    ...
    <div class="container">
        <form action="{{route('TeacherAssistant.update' , $teacherDetails->id)}}" method="post" class="form prof-sel">
            {{ csrf_field() }}
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <input class="form-control" type="text" placeholder="Enter user name.." name="username" value="{{$teacherDetails->username}}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input class="form-control" type="text" placeholder="Enter your email.." name="email" value="{{$teacherDetails->email}}">
                ...
                <div class="col-md-12">
                    ...
                    @foreach($allSubjects as $subject)
                        <input @if(in_array($subject->id, $teacherSubjects)) {{'checked'}} @endif id="{{$subject->name}}" type="checkbox" name="subjects[]" value="{{$subject->id}}"><label class="sub" for="{{$subject->name}}">{{$subject->name}}</label><br>
                    @endforeach
                </div>
